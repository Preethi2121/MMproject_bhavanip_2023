# -*- coding: utf-8 -*-
"""
Created on Mon Jan 16 10:33:12 2023
...
# Parameters
r = 0.25 # Species interaction rate
...
#Looping over time and space with explicit Forward time and centered symmetrical space FD approach with Neumann boundary conditions
for n in range(0, Nt-1):
    ...
    S[0,n+1] = S[1,n+1] # derivative of S at the left boundary is zero
    S[Nx-1,n+1] = S[Nx-2,n+1] # derivative of S at the right boundary is zero
    I[0,n+1] = I[1,n+1] # derivative of I at the left boundary is zero
    I[Nx-1,n+1] = I[Nx-1,n] + dt*r*S[Nx-1,n]*I[Nx-1,n] - dt*d*I[Nx-1,n] + dt*D*(I[0,n] + I[Nx-2,n] - 2*I[Nx-1,n])/dx**2 # derivative of I at the right boundary is zer0
...
plt.xlabel('Space')
plt.title('2D plot of Population density vs Spcae with Neumann boundary conditions & Explicit FTCS FD scheme')
...
plt.ylabel('Population density')
plt.xlabel('Time')
plt.title('2D plot of Population density vs Time with Neumann boundary conditions & Explicit FTCS FD scheme')
...
ax1.set_title('3D plot of Susceptible population in time and space with FTCS explicit FD scheme')
...
ax2.set_title('3D plot of Infected population in time and space with FTCS explicit FD scheme')
plt.show()
